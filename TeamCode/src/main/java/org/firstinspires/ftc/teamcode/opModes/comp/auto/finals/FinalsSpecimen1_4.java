...
@Autonomous(name = "Specimen1_4", group = "AAA_COMP", preselectTeleOp="RedTeleOp")
public class FinalsSpecimen1_4 extends LinearOpMode {
    Robot_V2 robot = new Robot_V2(FinalsAutoConstants.STARTING_POSITION_SPECIMEN, true);

    boolean isDone = false;

    double clipWaitSeconds = 2.1;
    ...
    public void runOpMode() {
        ...
        Action repeatHangOne = robot.drivebase.drive.actionBuilder(FinalsAutoConstants.PUSHED_RELOCALIZE_POSE)
        ...
        Action repeatHangTwo = robot.drivebase.drive.actionBuilder(FinalsAutoConstants.PUSHED_RELOCALIZE_POSE)
                .setTangent(FinalsAutoConstants.HANG_A_SET_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_A, FinalsAutoConstants.HANG_A_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_B, FinalsAutoConstants.HANG_B_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_C, FinalsAutoConstants.HANG_C_TANGENT)
        ...
        Action repeatHangThree = robot.drivebase.drive.actionBuilder(FinalsAutoConstants.PUSHED_RELOCALIZE_POSE)
                .setTangent(FinalsAutoConstants.HANG_A_SET_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_A, FinalsAutoConstants.HANG_A_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_B, FinalsAutoConstants.HANG_B_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_C, FinalsAutoConstants.HANG_C_TANGENT)
        ...
        Action repeatHangFour = robot.drivebase.drive.actionBuilder(FinalsAutoConstants.PUSHED_RELOCALIZE_POSE)
                .setTangent(FinalsAutoConstants.HANG_A_SET_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_A, FinalsAutoConstants.HANG_A_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_B, FinalsAutoConstants.HANG_B_TANGENT)
                .splineToLinearHeading(FinalsAutoConstants.HANG_C, FinalsAutoConstants.HANG_C_TANGENT)
                            ...
                            new SequentialAction(
                                    ...
                                    new ParallelAction(
                                            ...
                                            new SequentialAction(
                                                ...
                                                (telemetryPacket) -> { // Score
                                                    robot.scoringAssembly.multiAxisArm.toggleSpecimen();
                                                    return false;
                                                },
                                                new SleepAction(0.2),
                                                    (telemetryPacket) -> { // Open Hand
