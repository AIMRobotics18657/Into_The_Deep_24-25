...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1515; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -795; // x position of the perpendicular encoder (in tick units)
    }
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d pose) {
        ...
        par = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, ConfigurationInfo.rightBack.getDeviceName())));
        perp = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, ConfigurationInfo.rightFront.getDeviceName())));
